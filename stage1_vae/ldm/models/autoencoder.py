...
from ldm.modules.diffusionmodules.model import Encoder, Encoder_fix,Decoder, Decoder_Mix
...
class AutoencoderKLResi(pl.LightningModule):
    def __init__(self,
        ...
        super().__init__()
        self.image_key = image_key
        self.encoder = Encoder_fix(**ddconfig)
...
class AutoencoderKLGTResi(pl.LightningModule):
    def __init__(self,
                 ddconfig,
                 lossconfig,
                 embed_dim,
